...
from models.arima import train_arima_on_history
...
def main():
   ...
   # Обучение RF
    ...
    # Обучение ARIMA
    metrics_arima, path_arima = train_arima_on_history(df, ticker)
    ...
    # Прогноз на 30 дней, график и запись в JSON
    forecast_info = rf_forecast_30_days(
        df,
        ticker,
    ...
    print("График сохранен в:", forecast_info["plot_path"])
